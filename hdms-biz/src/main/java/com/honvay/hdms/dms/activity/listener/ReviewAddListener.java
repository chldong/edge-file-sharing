...
@Slf4j
@Component
public class ReviewAddListener implements ApplicationListener<ReviewAddEvent> {

	@Autowired
	private ActivityService activityService;

	@Override
	public void onApplicationEvent(ReviewAddEvent event) {
		...
		Activity activity = Activity.builder()
				...
				.operation(OperationType.REVIEW_ADD)
				.build();
